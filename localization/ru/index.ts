...
export default {
	...
	payment: {
		...
		stageDescriptionRemaining: "{{count}} из {{total}} курсов",
		stagePriceLabel: "Цена этапа: {{price}}",
		stageButton: "Купить этап за {{price}}",
		buyStage: "Купить этап",
		coursePriceLabel: "Цена курса: {{price}}",
		successTitle: "Успех",
		courseAlreadyPurchased: "Этот курс уже доступен.",
		stageAlreadyPurchased: "Этап уже открыт.",
		allCoursesAlreadyPurchased: "Все курсы уже куплены",
		buyFullAccess: "Купить полный доступ",
